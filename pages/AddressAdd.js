...
class AddressAdd extends Component {
    ...
    insert(e){
        ...
        const link = "http://localhost:3001/insert_address/"+this.state.cuid;
        console.log(link);
        fetch(link, {
            method: "POST",
            headers: {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input required type="text" name="afname" value={this.state.afname} onChange={this.handleChange} /><br />
                    ...
                    <select  name="ccoid" onChange={this.handleChange} required value={this.state.ccoid}>
                        ...
                        <option selected value="TH" name="ccoid">Thailand</option>
                    ...
                    <input type="submit" value="Save" onClick={(e) => this.insert(e)} />
                </form>
            </div>
        );
    }
